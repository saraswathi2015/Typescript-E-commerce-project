...
const initStateCart:CartStateType = {cart:[]}
...
const reducer = (state:CartStateType,action:ReducerAction) =>{
    switch(action.type){
        ...
        default:
            throw new Error('Unidefined reducer action type')
    }
}

 const useCartContext = (initCartState:CartStateType) =>{
    // const useCartContext = (initCartState:CartStateType):CartStateType[] =>{
...
export const CartProvider = ({children}:ChildrenType):ReactElement=>{
    return(
        <CartContext.Provider value={useCartContext(initStateCart)}>{children}</CartContext.Provider>
    )
}
